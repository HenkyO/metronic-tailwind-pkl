            ...
            <div class="flex items-center gap-2 lg:gap-3.5">
                ...
                <div class="dropdown" data-dropdown="true" data-dropdown-offset="170px, 10px" data-dropdown-placement="bottom-end" data-dropdown-trigger="click|lg:click">
                        ...
                        <div class="shadow-card border-b border-gray-200 py-2.5">
                            <div class="flex items-center justify-between flex-wrap gap-2 px-5">
                                ...
                                <div class="flex -space-x-2">
                                    ...
                                    <div class="flex">
                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="/media/avatars/Bahteramon Bintang.jpg"/>
                                    </div>
                                    <div class="flex">
                    ...
                    <div class="scrollable-y-auto" data-scrollable="true" data-scrollable-dependencies="#header" data-scrollable-max-height="auto" data-scrollable-offset="280px">
                        <div class="flex flex-col gap-5 py-5">
                            ...
                            <div class="flex items-end justify-end gap-3.5 px-5">
                                ...
                                <img alt="" class="rounded-full size-9" src="/media/avatars/Bahteramon Bintang.jpg"/>
                    ...
                    <div class="mb-2.5">
                        ...
                        <div class="relative grow mx-5">
                            <img alt="" class="rounded-full size-[30px] absolute left-0 top-2/4 -translate-y-2/4 ms-2.5" src="/media/avatars/Bahteramon Bintang.jpg"/>
                                    ...
                                    <div class="flex flex-col gap-3 grow">
                                        ...
                                        <div class="card shadow-none p-3.5 gap-3.5 rounded-lg bg-light-active">
                                            ...
                                            <div class="flex -space-x-2">
                                                ...
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-6" src="/media/avatars/Bahteramon Bintang.jpg"/>
                                                </div>
                                            </div>
                                            </div>
                                            <div class="flex items-center gap-2.5">
                ...
                <div class="menu" data-menu="true">
                    ...
                    <div class="menu-toggle btn btn-icon rounded-full">
                        <img alt="" class="size-9 rounded-full border-2 border-success shrink-0" src="/media/avatars/Bahteramon Bintang.jpg">
                        </img>
                    </div>
                    <div class="menu-dropdown menu-default light:border-gray-300 w-full max-w-[250px]">
                        <div class="flex items-center justify-between px-5 py-1.5 gap-1.5">
                            <div class="flex items-center gap-2">
                                <img alt="" class="size-9 rounded-full border-2 border-success" src="/media/avatars/Bahteramon Bintang.jpg">
                                <div class="flex flex-col gap-1.5">
